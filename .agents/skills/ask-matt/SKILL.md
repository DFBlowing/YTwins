---
name: ask-matt
description: 当不确定哪个 skill 或 flow 适合当前处境时使用。本仓库全部 skill 的路由器。
...
- **`/wait-what`** is the corrective for a message that didn't land. Use it mid-conversation, inside any other skill, and the agent re-pitches what it just said with the context you were missing, in plain Chinese, using the `CONTEXT.md` vocabulary. It works after the fact; `/grill-with-docs` is the upfront cure, because a shared language agreed early is what stops the jargon arriving at all.
